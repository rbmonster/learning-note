...
```
![avatar](https://gitee.com/rbmon/file-storage/blob/main/learning-note/other/redis/encodingCode.jpg)
...
"raw"
```
![avatar](https://gitee.com/rbmon/file-storage/blob/main/learning-note/other/redis/stringCommand.jpg)
...
"linkedlist"
```
![avatar](https://gitee.com/rbmon/file-storage/blob/main/learning-note/other/redis/listCommand.jpg)
...
"hashtable"
```
![avatar](https://gitee.com/rbmon/file-storage/blob/main/learning-note/other/redis/hashCommand.jpg)
...
"hashtable"
```
![avatar](https://gitee.com/rbmon/file-storage/blob/main/learning-note/other/redis/setCommand.jpg)
...
"skiplist"
```
![image](https://gitee.com/rbmon/file-storage/blob/main/learning-note/other/redis/zsetCommand.jpg)
...
![image](https://gitee.com/rbmon/file-storage/blob/main/learning-note/other/redis/databaseDict.jpg)  
...
![image](https://gitee.com/rbmon/file-storage/blob/main/learning-note/other/redis/RDBLoad.jpg)  
...
![image](https://gitee.com/rbmon/file-storage/blob/main/learning-note/other/redis/AOFLoad.jpg)  
...
![image](https://gitee.com/rbmon/file-storage/blob/main/learning-note/other/redis/fileProcesser.jpg)  

- 客户端与服务器的通信过程
![image](https://gitee.com/rbmon/file-storage/blob/main/learning-note/other/redis/client2server.jpg)
...
- 设置的操作流程
  ...
  4. 身份验证。主从服务器是否均配置了masterauth选项。
    - ![image](https://gitee.com/rbmon/file-storage/blob/main/learning-note/other/redis/masterauth.jpg)
...
![image](https://gitee.com/rbmon/file-storage/blob/main/learning-note/other/redis/slaveCopy.jpg)

![image](https://gitee.com/rbmon/file-storage/blob/main/learning-note/other/redis/psync.jpg)
...
![image](https://gitee.com/rbmon/file-storage/blob/main/learning-note/other/redis/sentinel.jpg)
...
```
![image](https://gitee.com/rbmon/file-storage/blob/main/learning-note/other/redis/cluster.jpg)
...
![image](https://gitee.com/rbmon/file-storage/blob/main/learning-note/other/redis/askError.jpg)
![image](https://gitee.com/rbmon/file-storage/blob/main/learning-note/other/redis/slotReadd.jpg)
...
![image](https://gitee.com/rbmon/file-storage/blob/main/learning-note/other/redis/transaction.png)
...
- WATCH为一个乐观锁实现。
  ...
  - ```
    ...
    (nil)
    ```
![image](https://gitee.com/rbmon/file-storage/blob/main/learning-note/other/redis/optiLock.jpg)
...
## 排序
![image](https://gitee.com/rbmon/file-storage/blob/main/learning-note/other/redis/sort.jpg)
![image](https://gitee.com/rbmon/file-storage/blob/main/learning-note/other/redis/sort2.jpg)
