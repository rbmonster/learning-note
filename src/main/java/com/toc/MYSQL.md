...
&emsp;&emsp;<a href="#62">6.5. 多版本并发控制（Multi-Version Concurrency Control，MVCC）</a>  
...
&emsp;&emsp;&emsp;<a href="#126">11.2.1. 分库分表场景</a>  
...
#### <a name="61">脏读问题出现</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="77">crash-safe的设置</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="78">两阶段提交</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="79">两种日志区别</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="80">两阶段提交的组提交机制执行流程</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
## <a name="81">实际sql的执行</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
一个sql 语句mysql的执行顺序：
...
### <a name="82">count(*)实现</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
不同引擎中的实现
...
### <a name="83">order by 处理流程</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
#### <a name="84">全字段排序</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="85">rowId排序</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="86">join的执行过程</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
以下为三种join算法，主要的区别在于连接的字段是否有索引
#### <a name="87">Index Nested-Loop Join</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="88">Simple Nested-Loop Join</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="89">Block Nested-Loop Join</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
执行过程：
...
#### <a name="90">join语句mysql的优化</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
`Multi-Range Read`优化
...
#### <a name="91">总结</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="92">union执行流程</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="93">group by 执行流程</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="94">优化-索引</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
索引保证了数据有序，在group by时候，分组计数计算时一片区域的id都是连续的，整个表扫描结束时便可以拿到结果，不需要临时表也不需要排序。

#### <a name="95">优化-直接排序</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
确保数据量确实超过了`sort buffer`，可以直接强制mysql直接使用磁盘文件排序。\
`select SQL_BIG_RESULT id%100 as m, count(*) as c from t1 group by m;`

#### <a name="96">小结</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
## <a name="97">MySQL中的组件</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

### <a name="98">Buffer Pool</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="99">内存管理策略</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="100">change buffer</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="101">change buffer 和 redo log</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="102">sort buffer</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
sort_buffer_size: 是MySQL为排序开辟的内存（`sort_buffer`） 的大小。 `如果要排序的数据量小于sort_buffer_size`，排序就在内存中完成。 但如果排序数据量太大内存放不下，则不得不利用磁盘临时文件辅助排序。
> sort_buffer_size大于了需要排序的数据量的大小，number_of_tmp_files就是0，排序直接在内存完成。

具体可见order by排序章节

### <a name="103">内存临时表</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="104">磁盘临时表</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="105">binlog cache</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
系统给binlog cache分配了一片内存，每个线程一个，参数 binlog_cache_size用于控制单个线程 内binlog cache所占内存的大小。如果超过了这个参数规定的大小，就要暂存到磁盘。

### <a name="106">redo log buffer</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

### <a name="107">net_buffer</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="108">join buffer</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
join_buffer的大小是由参数join_buffer_size设定的，默认值是256k。如果放不下驱动表的所有数据，策略很简单就是分段放。

## <a name="109">数据库设计</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

### <a name="110">数据库设计原则</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

#### <a name="111">第一范式(列不可再分)</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="112">第二范式(确保表中的每列都和主键相关)</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
第二范式需要确保数据库表中的每一列都和主键相关，而不能只与主键的某一部分相关（主要针对联合主键而言）。也就是说在一个数据库表中，一个表中只能保存一种数据，不可以把多种数据保存在同一张数据库表中。
> 如一个订单的商品明细表，不应该订单主表的ID放到商品明细表中，会导致数据冗余

#### <a name="113">第三范式(确保每列都和主键列直接相关,而不是间接相关)</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
第三范式需要确保数据表中的每一列数据都和主键直接相关，而不能间接相关。
> 如一个订单表都会有客户字段，可以把客户编码作为一个外键跟订单表建立响应关系。

#### <a name="114">相关资料</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
[数据库设计三大范式](https://www.cnblogs.com/linjiqin/archive/2012/04/01/2428695.html)

### <a name="115">表字段设计</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="116">乐观锁字段</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
使用version作为乐观锁的控制。

#### <a name="117">通用字段</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
创建人、创建时间、修改人、修改时间

#### <a name="118">日期字段的选择</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="119">分区与分表</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
#### <a name="120">分区</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="121">分表</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
分表：分表是将一个大表按照一定的规则分解成多张具有独立存储空间的实体表。

**详细可见sharding-jdbc 分库分表**

### <a name="122">实际设计问题 —— 设计部门表 </a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
设计一张部门表应该有哪些必要字段？
...
## <a name="123">MySQL架构</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

### <a name="124">主从模式(读写分离)</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
读写分离的主要目标就是分摊主库的压力
...
### <a name="125">分库分表</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

#### <a name="126">分库分表场景</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
由于数据量过大而导致数据库性能降低的问题，将原来独立的数据库拆分成若干数据库组成 ，将数据大表拆分成若干数据表组成，使得单一数据库、单一数据表的数据量变小，从而达到提升数据库性能的目的。

#### <a name="127">垂直切分</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="128">水平切分</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
水平分库是把同一个表的数据按一定规则拆到不同的数据库中，每个库可以放在不同的服务器上。
> 如将店铺ID为单数的和店铺ID为双数的商品信息分别放在两个库中。

水平分表是在同一个数据库内，把同一个表的数据按一定规则拆到多个表中。

#### <a name="129">分库分表的查询</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="130">MGR(MySQL Group Replication)</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="131">主从数据同步</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
参考资料：
...
#### <a name="132">MySQL异步复制</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="133">MySQL半同步复制</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="134">MySQL组复制</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
基于传统异步复制和半同步复制的缺陷——数据的一致性问题无法保证

## <a name="135">其他面试题</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

### <a name="136">主键索引是否使用自增</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
使用自增好处：
...
### <a name="137">临时表与内存表</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
内存表，指的是使用Memory引擎的表
...
### <a name="138">重建索引是否合理</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="139">mysql数据库抖动</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="140">读已提交和可重复读是如何实现的</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
1. ReadView：\
...
### <a name="141">读已提交和可重复读区别？</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
举两个事务线程的例子。
     
### <a name="142">数据库数据库一致性是如何实现的？</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
通过redoLog 与binlog 两阶段提交 保证事务一致性。

### <a name="143">redoLog、undoLog、binlog区别？</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="144">两种日志有以下三点不同</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="145">一个事务开启什么时候产生三种日志？</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
1. 事务开启
...
### <a name="146">可重复读隔离级别下，事务中select一条记录巨慢</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
session A：
```
start transaction;
// 时刻A
...
### <a name="147">数据库什么情况会出现死锁？如何处理死锁？</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="148">由于索引导致的死锁</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="149">order by 优化</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
Order by查询的两种情况：
...
#### <a name="150">sub-query 子查询</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
对于子查询，一般的优化策略是做等价改写
...
#### <a name="151">limit 优化 - 延迟关联</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
##### <a name="152">相关资料</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="153">Or/And Condition</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
处理策略
1. And子句多个条件中拥有一个过滤性较高的索引即可;
2. Or条件前后字段均要创建索引;
3. 为最常用的And组合条件创建复合索引。

#### <a name="154">join 优化</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="155">数据库连接池、数据库连接线程安全的吗？</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="156">InnoDB 和 MyIsam 数据库引擎的区别</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="157">MySQL数据页(储存页)</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="158">高并发数据库读写压力大怎么处理？</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="159">其他</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
#### <a name="160">什么是覆盖索引跟回表？</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
见索引规则

#### <a name="161">`left join,right join,inner join`,表表关联什么区别？</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="162">大事务会有什么影响？</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
