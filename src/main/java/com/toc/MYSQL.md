...
&emsp;&emsp;&emsp;<a href="#24">2.5.5. 其他</a>  
...
&emsp;&emsp;<a href="#39">4.2. RR可重复读（Repeatable Read）</a>  
...
&emsp;<a href="#65">6. 实际sql的执行</a>  
&emsp;&emsp;<a href="#66">6.1. count(*)实现</a>  
&emsp;&emsp;<a href="#67">6.2. order by 处理流程</a>  
&emsp;&emsp;&emsp;<a href="#68">6.2.1. 全字段排序</a>  
&emsp;&emsp;&emsp;<a href="#69">6.2.2. rowId排序</a>  
&emsp;&emsp;<a href="#70">6.3. join的执行过程</a>  
&emsp;&emsp;&emsp;<a href="#71">6.3.1. Index Nested-Loop Join</a>  
&emsp;&emsp;&emsp;<a href="#72">6.3.2. Simple Nested-Loop Join</a>  
&emsp;&emsp;&emsp;<a href="#73">6.3.3. Block Nested-Loop Join</a>  
&emsp;&emsp;&emsp;<a href="#74">6.3.4. join语句mysql的优化</a>  
&emsp;&emsp;&emsp;<a href="#75">6.3.5. 总结</a>  
&emsp;&emsp;<a href="#76">6.4. union执行流程</a>  
&emsp;&emsp;&emsp;<a href="#77">6.4.1. union all</a>  
&emsp;&emsp;<a href="#78">6.5. group by 执行流程</a>  
&emsp;&emsp;&emsp;<a href="#79">6.5.1. group by 优化 ——索引</a>  
&emsp;&emsp;&emsp;<a href="#80">6.5.2. group by 优化 —— 直接排序</a>  
&emsp;<a href="#81">7. 数据库设计</a>  
&emsp;&emsp;<a href="#82">7.1. 数据库设计原则</a>  
&emsp;&emsp;&emsp;<a href="#83">7.1.1. 第一范式(列不可再分)</a>  
&emsp;&emsp;&emsp;<a href="#84">7.1.2. 第二范式(确保表中的每列都和主键相关)</a>  
&emsp;&emsp;&emsp;<a href="#85">7.1.3. 第三范式(确保每列都和主键列直接相关,而不是间接相关)</a>  
&emsp;&emsp;&emsp;<a href="#86">7.1.4. 相关资料</a>  
&emsp;&emsp;<a href="#87">7.2. 表字段设计</a>  
&emsp;&emsp;&emsp;<a href="#88">7.2.1. 乐观锁字段</a>  
&emsp;&emsp;&emsp;<a href="#89">7.2.2. 通用字段</a>  
&emsp;&emsp;&emsp;<a href="#90">7.2.3. 日期字段的选择</a>  
&emsp;&emsp;<a href="#91">7.3. 实际设计问题 —— 设计部门表 </a>  
&emsp;<a href="#92">8. 分库分表</a>  
&emsp;&emsp;<a href="#93">8.1. 分库分表有了解吗？</a>  
&emsp;&emsp;<a href="#94">8.2. 垂直切分</a>  
&emsp;&emsp;<a href="#95">8.3. 水平切分</a>  
&emsp;<a href="#96">9. 其他面试题</a>  
&emsp;&emsp;<a href="#97">9.1. mysql数据库抖动</a>  
&emsp;&emsp;<a href="#98">9.2. 读已提交和可重复读是如何实现的</a>  
&emsp;&emsp;<a href="#99">9.3. 读已提交和可重复读区别？</a>  
&emsp;&emsp;<a href="#100">9.4. 数据库数据库一致性是如何实现的？</a>  
&emsp;&emsp;<a href="#101">9.5. redoLog、undoLog、binlog区别？</a>  
&emsp;&emsp;&emsp;<a href="#102">9.5.1. 两种日志有以下三点不同</a>  
&emsp;&emsp;<a href="#103">9.6. 一个事务开启什么时候产生三种日志？</a>  
&emsp;&emsp;<a href="#104">9.7. 数据库什么情况会出现死锁？如何处理死锁？</a>  
&emsp;&emsp;&emsp;<a href="#105">9.7.1. 由于索引导致的死锁</a>  
&emsp;&emsp;<a href="#106">9.8. 如何优化SQL</a>  
&emsp;&emsp;<a href="#107">9.9. 数据库连接池、数据库连接线程安全的吗？</a>  
&emsp;&emsp;<a href="#108">9.10. mysql 查询大表</a>  
&emsp;&emsp;&emsp;<a href="#109">9.10.1. 延迟关联</a>  
&emsp;&emsp;&emsp;<a href="#110">9.10.2. 小案例</a>  
&emsp;&emsp;&emsp;<a href="#111">9.10.3. 相关资料</a>  
&emsp;&emsp;<a href="#112">9.11. InnoDB 和 MyIsam 数据库引擎的区别</a>  
&emsp;&emsp;<a href="#113">9.12. MySQL储存页</a>  
&emsp;&emsp;<a href="#114">9.13. 高并发数据库读写压力大怎么处理？</a>  
&emsp;&emsp;<a href="#115">9.14. 其他</a>  
...
### <a name="39">RR可重复读（Repeatable Read）</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
见幻读章节
...
## <a name="65">实际sql的执行</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
一个sql 语句mysql的执行顺序：

`from -- on  -- JOIN -- where -- group by -- having -- select -- distinct -- order by -- limit`
### <a name="66">count(*)实现</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
不同引擎中的实现
...
### <a name="67">order by 处理流程</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
#### <a name="68">全字段排序</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
```
CREATE TABLE `t` (
`id` int(11) NOT NULL,
...
#### <a name="69">rowId排序</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="70">join的执行过程</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
#### <a name="71">Index Nested-Loop Join</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
```
...
#### <a name="72">Simple Nested-Loop Join</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
```
...
#### <a name="73">Block Nested-Loop Join</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
将驱动表数据读入线程内存join_buffer中，同样以全表扫描，但是因为使用内存操作，速度比上述方法快。

#### <a name="74">join语句mysql的优化</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
Multi-Range Read优化
...
#### <a name="75">总结</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
1. 尽量使用被驱动表的索引，即关联表的字段为索引。
2. 不能使用被驱动表的索引， 只能使用Block Nested-Loop Join算法， 这样的语句就尽量不要使用；
3. 在使用join的时候， 应该让小表做驱动表。
4. 把join 的条件写在where和写在on中区别为，一个为连接的条件。

### <a name="76">union执行流程</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
```
...
#### <a name="77">union all</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
```
...
```
#### <a name="79">group by 优化 ——索引</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
索引保证了数据有序，在group by时候，分组计数计算时一片区域的id都是连续的，整个表扫描结束时便可以拿到结果，不需要临时表也不需要排序。

#### <a name="80">group by 优化 —— 直接排序</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
## <a name="81">数据库设计</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

### <a name="82">数据库设计原则</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

#### <a name="83">第一范式(列不可再分)</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="84">第二范式(确保表中的每列都和主键相关)</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
第二范式需要确保数据库表中的每一列都和主键相关，而不能只与主键的某一部分相关（主要针对联合主键而言）。也就是说在一个数据库表中，一个表中只能保存一种数据，不可以把多种数据保存在同一张数据库表中。
> 如一个订单的商品明细表，不应该订单主表的ID放到商品明细表中，会导致数据冗余

#### <a name="85">第三范式(确保每列都和主键列直接相关,而不是间接相关)</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
第三范式需要确保数据表中的每一列数据都和主键直接相关，而不能间接相关。
> 如一个订单表都会有客户字段，可以把客户编码作为一个外键跟订单表建立响应关系。

#### <a name="86">相关资料</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
- https://www.cnblogs.com/linjiqin/archive/2012/04/01/2428695.html

### <a name="87">表字段设计</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="88">乐观锁字段</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
使用version作为乐观锁的控制。

#### <a name="89">通用字段</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
创建人、创建时间、修改人、修改时间

#### <a name="90">日期字段的选择</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="91">实际设计问题 —— 设计部门表 </a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
设计一张部门表应该有哪些必要字段？
...
## <a name="92">分库分表</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

### <a name="93">分库分表有了解吗？</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
由于数据量过大而导致数据库性能降低的问题，将原来独立的数据库拆分成若干数据库组成 ，将数据大表拆分成若干数据表组成，使得单一数据库、单一数据表的数据量变小，从而达到提升数据库性能的目的。

### <a name="94">垂直切分</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="95">水平切分</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
水平分库是把同一个表的数据按一定规则拆到不同的数据库中，每个库可以放在不同的服务器上。
- 如将店铺ID为单数的和店铺ID为双数的商品信息分别放在两个库中。

水平分表是在同一个数据库内，把同一个表的数据按一定规则拆到多个表中。

## <a name="96">其他面试题</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

### <a name="97">mysql数据库抖动</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="98">读已提交和可重复读是如何实现的</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
1. ReadView：
...
### <a name="99">读已提交和可重复读区别？</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
- 举两个事务线程的例子。
     
### <a name="100">数据库数据库一致性是如何实现的？</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
- 通过redoLog 与binlog 两阶段提交 保证事务一致性。

### <a name="101">redoLog、undoLog、binlog区别？</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="102">两种日志有以下三点不同</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="103">一个事务开启什么时候产生三种日志？</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
1. 事务开启
...
### <a name="104">数据库什么情况会出现死锁？如何处理死锁？</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="105">由于索引导致的死锁</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="106">如何优化SQL</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="107">数据库连接池、数据库连接线程安全的吗？</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="108">mysql 查询大表</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

#### <a name="109">延迟关联</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="110">小案例</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
- 常规查询：
```
...
### <a name="112">InnoDB 和 MyIsam 数据库引擎的区别</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="113">MySQL储存页</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="114">高并发数据库读写压力大怎么处理？</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="115">其他</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
- 什么是覆盖索引跟回表？
见索引规则
