...
&emsp;<a href="#36">4. 锁与隔离级别</a>  
&emsp;&emsp;<a href="#37">4.1. 串行化</a>  
&emsp;&emsp;<a href="#38">4.2. RR可重复读（Repeatable Read）</a>  
&emsp;&emsp;&emsp;<a href="#39">4.2.1. 不可重复读问题解决</a>  
&emsp;&emsp;&emsp;<a href="#40">4.2.2. 幻读解决——范围锁（间隙锁+行锁）</a>  
&emsp;&emsp;<a href="#41">4.3. RC读已提交（Read Committed）</a>  
&emsp;&emsp;<a href="#42">4.4. 脏读解决</a>  
&emsp;&emsp;<a href="#43">4.5. 不可重复读问题出现</a>  
&emsp;&emsp;<a href="#44">4.6. RU读未提交（Read Uncommitted）</a>  
&emsp;&emsp;&emsp;<a href="#45">4.6.1. 脏读问题出现</a>  
&emsp;&emsp;<a href="#46">4.7. 多版本并发控制（Multi-Version Concurrency Control，MVCC）</a>  
&emsp;&emsp;&emsp;<a href="#47">4.7.1. 前置知识</a>  
&emsp;&emsp;&emsp;<a href="#48">4.7.2. MVCC原理</a>  
&emsp;&emsp;&emsp;&emsp;<a href="#49">4.7.2.1. 版本链</a>  
&emsp;&emsp;&emsp;&emsp;<a href="#50">4.7.2.2. undo log</a>  
&emsp;&emsp;&emsp;&emsp;<a href="#51">4.7.2.3. Read View(读视图)</a>  
&emsp;&emsp;&emsp;<a href="#52">4.7.3. 隔离级别与MVCC</a>  
&emsp;&emsp;&emsp;<a href="#53">4.7.4. 参考资料</a>  
&emsp;<a href="#54">5. redo log、undo log、binlog</a>  
&emsp;&emsp;<a href="#55">5.1. undo log</a>  
&emsp;&emsp;<a href="#56">5.2. redo log</a>  
&emsp;&emsp;&emsp;<a href="#57">5.2.1. redo log 写入机制</a>  
&emsp;&emsp;<a href="#58">5.3. binlog</a>  
&emsp;&emsp;&emsp;<a href="#59">5.3.1. bin log写入机制</a>  
&emsp;&emsp;<a href="#60">5.4. 两种日志区别</a>  
&emsp;&emsp;<a href="#61">5.5. 两阶段提交</a>  
&emsp;&emsp;&emsp;<a href="#62">5.5.1. 为何需要两个日志</a>  
&emsp;&emsp;&emsp;<a href="#63">5.5.2. 两阶段提交的实际执行流程</a>  
&emsp;<a href="#64">6. 实际sql的执行</a>  
&emsp;&emsp;<a href="#65">6.1. count(*)实现</a>  
&emsp;&emsp;<a href="#66">6.2. order by 处理流程</a>  
&emsp;&emsp;&emsp;<a href="#67">6.2.1. 全字段排序</a>  
&emsp;&emsp;&emsp;<a href="#68">6.2.2. rowId排序</a>  
&emsp;&emsp;<a href="#69">6.3. join的执行过程</a>  
&emsp;&emsp;&emsp;<a href="#70">6.3.1. Index Nested-Loop Join</a>  
&emsp;&emsp;&emsp;<a href="#71">6.3.2. Simple Nested-Loop Join</a>  
&emsp;&emsp;&emsp;<a href="#72">6.3.3. Block Nested-Loop Join</a>  
&emsp;&emsp;&emsp;<a href="#73">6.3.4. join语句mysql的优化</a>  
&emsp;&emsp;&emsp;<a href="#74">6.3.5. 总结</a>  
&emsp;&emsp;<a href="#75">6.4. union执行流程</a>  
&emsp;&emsp;&emsp;<a href="#76">6.4.1. union all</a>  
&emsp;&emsp;<a href="#77">6.5. group by 执行流程</a>  
&emsp;&emsp;&emsp;<a href="#78">6.5.1. group by 优化 ——索引</a>  
&emsp;&emsp;&emsp;<a href="#79">6.5.2. group by 优化 —— 直接排序</a>  
&emsp;<a href="#80">7. 数据库设计</a>  
&emsp;&emsp;<a href="#81">7.1. 数据库设计原则</a>  
&emsp;&emsp;&emsp;<a href="#82">7.1.1. 第一范式(列不可再分)</a>  
&emsp;&emsp;&emsp;<a href="#83">7.1.2. 第二范式(确保表中的每列都和主键相关)</a>  
&emsp;&emsp;&emsp;<a href="#84">7.1.3. 第三范式(确保每列都和主键列直接相关,而不是间接相关)</a>  
&emsp;&emsp;&emsp;<a href="#85">7.1.4. 相关资料</a>  
&emsp;&emsp;<a href="#86">7.2. 表字段设计</a>  
&emsp;&emsp;&emsp;<a href="#87">7.2.1. 乐观锁字段</a>  
&emsp;&emsp;&emsp;<a href="#88">7.2.2. 通用字段</a>  
&emsp;&emsp;&emsp;<a href="#89">7.2.3. 日期字段的选择</a>  
&emsp;&emsp;<a href="#90">7.3. 实际设计问题 —— 设计部门表 </a>  
&emsp;<a href="#91">8. 分库分表</a>  
&emsp;&emsp;<a href="#92">8.1. 分库分表有了解吗？</a>  
&emsp;&emsp;<a href="#93">8.2. 垂直切分</a>  
&emsp;&emsp;<a href="#94">8.3. 水平切分</a>  
&emsp;<a href="#95">9. 其他面试题</a>  
&emsp;&emsp;<a href="#96">9.1. mysql数据库抖动</a>  
&emsp;&emsp;<a href="#97">9.2. 读已提交和可重复读是如何实现的</a>  
&emsp;&emsp;<a href="#98">9.3. 读已提交和可重复读区别。</a>  
&emsp;&emsp;<a href="#99">9.4. 数据库数据库一致性是如何实现的？</a>  
&emsp;&emsp;<a href="#100">9.5. redolog、undolog、binlog区别？</a>  
&emsp;&emsp;<a href="#101">9.6. 两种日志有以下三点不同。</a>  
&emsp;&emsp;<a href="#102">9.7. 数据库什么情况会出现死锁？如何处理死锁？</a>  
&emsp;&emsp;<a href="#103">9.8. 如何优化SQL</a>  
&emsp;&emsp;<a href="#104">9.9. 数据库连接池、数据库连接线程安全的吗？</a>  
&emsp;&emsp;<a href="#105">9.10. mysql 查询大表</a>  
&emsp;&emsp;&emsp;<a href="#106">9.10.1. 延迟关联</a>  
&emsp;&emsp;&emsp;<a href="#107">9.10.2. 小案例</a>  
&emsp;&emsp;&emsp;<a href="#108">9.10.3. 相关资料</a>  
&emsp;&emsp;<a href="#109">9.11. InnoDB 和 MyIsam 数据库引擎的区别</a>  
&emsp;&emsp;<a href="#110">9.12. MySQL储存页</a>  
...
## <a name="36">锁与隔离级别</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="37">串行化</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="38">RR可重复读（Repeatable Read）</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
见幻读章节

> 可重复读对**事务所涉及的数据加读锁和写锁**，且一直持有至事务结束，但不再加范围锁。

#### <a name="39">不可重复读问题解决</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="40">幻读解决——范围锁（间隙锁+行锁）</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
Innodb 为解决幻读问题引入了间隙锁+行锁充当范围锁

### <a name="41">RC读已提交（Read Committed）</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="42">脏读解决</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
例子：
...
### <a name="43">不可重复读问题出现</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
例子：
...
### <a name="44">RU读未提交（Read Uncommitted）</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
> 读未提交对事务涉及的数据只加写锁，会一直持续到事务结束，但完全不加读锁。\
> 注意⚠️：写锁禁止其他事务施加读锁，而不是禁止事务读取数据，如果事务 T1 读取数据并不需要去加读锁的话，就会导致事务 T2 未提交的数据也马上就能被事务 T1 所读到。

#### <a name="45">脏读问题出现</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="46">多版本并发控制（Multi-Version Concurrency Control，MVCC）</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
多版本并发控制MVCC: 是一种无锁读取的优化策略，它的“无锁”是特指读取时不需要加锁。MVCC 的基本思路是对数据库的任何修改都不会直接覆盖之前的数据，而是产生一个新版副本与老**版本**共存，以此达到读取时可以完全不加锁的目的。


#### <a name="47">前置知识</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="48">MVCC原理</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
##### <a name="49">版本链</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
##### <a name="50">undo log</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
见undolog 章节

##### <a name="51">Read View(读视图)</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
事务进行快照读操作的时候生产的读视图(Read View)，在该事务执行的快照读的那一刻，会生成数据库系统当前的一个快照。\
记录并维护系统当前活跃事务的ID(没有commit，当每个事务开启时，都会被分配一个ID, 这个ID是递增的，所以越新的事务，ID值越大)，是系统中当前不应该被本事务看到的其他事务id列表。


#### <a name="52">隔离级别与MVCC</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="53">参考资料</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
## <a name="54">redo log、undo log、binlog</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
### <a name="55">undo log</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="56">redo log</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="57">redo log 写入机制</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="58">binlog</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="59">bin log写入机制</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="60">两种日志区别</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="61">两阶段提交</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="62">为何需要两个日志</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="63">两阶段提交的实际执行流程</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
## <a name="64">实际sql的执行</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
一个sql 语句mysql的执行顺序：

`from -- on  -- JOIN -- where -- group by -- having -- select -- distinct -- order by -- limit`
### <a name="65">count(*)实现</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
不同引擎中的实现
...
### <a name="66">order by 处理流程</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
#### <a name="67">全字段排序</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
```
CREATE TABLE `t` (
`id` int(11) NOT NULL,
...
#### <a name="68">rowId排序</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="69">join的执行过程</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
#### <a name="70">Index Nested-Loop Join</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
```
...
#### <a name="71">Simple Nested-Loop Join</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
```
...
#### <a name="72">Block Nested-Loop Join</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
将驱动表数据读入线程内存join_buffer中，同样以全表扫描，但是因为使用内存操作，速度比上述方法快。

#### <a name="73">join语句mysql的优化</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
Multi-Range Read优化
...
#### <a name="74">总结</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
1. 尽量使用被驱动表的索引，即关联表的字段为索引。
2. 不能使用被驱动表的索引， 只能使用Block Nested-Loop Join算法， 这样的语句就尽量不要使用；
3. 在使用join的时候， 应该让小表做驱动表。
4. 把join 的条件写在where和写在on中区别为，一个为连接的条件。

### <a name="75">union执行流程</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
```
...
#### <a name="76">union all</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
```
(select 1000 as f) union all(select id from t1 order by id desc limit 2);
```
- 与上面的区别为union all不需要除重，因此直接把查询结果放在结果集中返回。

### <a name="77">group by 执行流程</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
```
...
```
#### <a name="78">group by 优化 ——索引</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
索引保证了数据有序，在group by时候，分组计数计算时一片区域的id都是连续的，整个表扫描结束时便可以拿到结果，不需要临时表也不需要排序。

#### <a name="79">group by 优化 —— 直接排序</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
## <a name="80">数据库设计</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

### <a name="81">数据库设计原则</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

#### <a name="82">第一范式(列不可再分)</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="83">第二范式(确保表中的每列都和主键相关)</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
第二范式需要确保数据库表中的每一列都和主键相关，而不能只与主键的某一部分相关（主要针对联合主键而言）。也就是说在一个数据库表中，一个表中只能保存一种数据，不可以把多种数据保存在同一张数据库表中。
> 如一个订单的商品明细表，不应该订单主表的ID放到商品明细表中，会导致数据冗余

#### <a name="84">第三范式(确保每列都和主键列直接相关,而不是间接相关)</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
第三范式需要确保数据表中的每一列数据都和主键直接相关，而不能间接相关。
> 如一个订单表都会有客户字段，可以把客户编码作为一个外键跟订单表建立响应关系。

#### <a name="85">相关资料</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
- https://www.cnblogs.com/linjiqin/archive/2012/04/01/2428695.html

### <a name="86">表字段设计</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="87">乐观锁字段</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
使用version作为乐观锁的控制。

#### <a name="88">通用字段</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
创建人、创建时间、修改人、修改时间

#### <a name="89">日期字段的选择</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="90">实际设计问题 —— 设计部门表 </a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
设计一张部门表应该有哪些必要字段？
...
## <a name="91">分库分表</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

### <a name="92">分库分表有了解吗？</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
由于数据量过大而导致数据库性能降低的问题，将原来独立的数据库拆分成若干数据库组成 ，将数据大表拆分成若干数据表组成，使得单一数据库、单一数据表的数据量变小，从而达到提升数据库性能的目的。

### <a name="93">垂直切分</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="94">水平切分</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
水平分库是把同一个表的数据按一定规则拆到不同的数据库中，每个库可以放在不同的服务器上。
- 如将店铺ID为单数的和店铺ID为双数的商品信息分别放在两个库中。

水平分表是在同一个数据库内，把同一个表的数据按一定规则拆到多个表中。

## <a name="95">其他面试题</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

### <a name="96">mysql数据库抖动</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="97">读已提交和可重复读是如何实现的</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
1. ReadView：
...
### <a name="98">读已提交和可重复读区别。</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
- 举两个事务线程的例子。
     
### <a name="99">数据库数据库一致性是如何实现的？</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
- 通过redolog 与binlog 两阶段提交 保证事务一致性。

### <a name="100">redolog、undolog、binlog区别？</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="101">两种日志有以下三点不同。</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
1. redo log是InnoDB引擎特有的； binlog是MySQL的Server层实现的， 所有引擎都可以使用。
2. redo log是物理日志， 记录的是“在某个数据页上做了什么修改”； binlog是逻辑日志， 记录的是这个语句的原始逻辑， 比如“给ID=2这一行的c字段加1 ”。
3. redo log是循环写的， 空间固定会用完； binlog是可以追加写入的。 “追加写”是指binlog文件写到一定大小后会切换到下一个， 并不会覆盖以前的日志。
...
### <a name="102">数据库什么情况会出现死锁？如何处理死锁？</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="103">如何优化SQL</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="104">数据库连接池、数据库连接线程安全的吗？</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="105">mysql 查询大表</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

#### <a name="106">延迟关联</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="107">小案例</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
- 常规查询：
```
...
#### <a name="108">相关资料</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="109">InnoDB 和 MyIsam 数据库引擎的区别</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="110">MySQL储存页</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
