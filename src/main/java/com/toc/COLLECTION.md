...
&emsp;&emsp;&emsp;<a href="#3">ArrayList:  Object[]数组</a>  
&emsp;&emsp;&emsp;&emsp;<a href="#4"> 扩容</a>  
&emsp;&emsp;&emsp;&emsp;<a href="#5">删除元素</a>  
&emsp;&emsp;&emsp;&emsp;<a href="#6">快速失败</a>  
&emsp;&emsp;&emsp;<a href="#7">CopyOnWriteArrayList 读写分离list</a>  
&emsp;&emsp;&emsp;<a href="#8">LinkedList</a>  
&emsp;<a href="#9"> Map</a>  
&emsp;&emsp;<a href="#10">HashMap</a>  
&emsp;&emsp;&emsp;<a href="#11">put 操作</a>  
&emsp;&emsp;&emsp;&emsp;<a href="#12">扩容</a>  
&emsp;&emsp;&emsp;<a href="#13">HashMap红黑树查找：</a>  
&emsp;&emsp;&emsp;<a href="#14">hash 方法</a>  
&emsp;&emsp;<a href="#15">LinkedHashMap </a>  
&emsp;&emsp;<a href="#16">concurrentHashMap实现</a>  
&emsp;&emsp;&emsp;<a href="#17">get方法</a>  
&emsp;&emsp;&emsp;<a href="#18">put方法</a>  
&emsp;&emsp;&emsp;<a href="#19">扩容 addCount() -> transfer()</a>  
&emsp;&emsp;<a href="#20">WeakHashMap</a>  
&emsp;&emsp;<a href="#21">TreeMap</a>  
&emsp;<a href="#22">Set</a>  
&emsp;&emsp;<a href="#23">HashSet</a>  
&emsp;&emsp;<a href="#24">LinkedHashSet实现</a>  
&emsp;&emsp;<a href="#25">TreeSet 实现</a>  
&emsp;<a href="#26">迭代器</a>  
&emsp;<a href="#27">其他</a>  
&emsp;&emsp;<a href="#28">如何选用集合?</a>  
