...
&emsp;&emsp;<a href="#16">5.2. 分布式</a>  
&emsp;&emsp;<a href="#17">5.3. 微服务</a>  
&emsp;&emsp;&emsp;<a href="#18">5.3.1. 拆分原则</a>  
&emsp;&emsp;&emsp;<a href="#19">5.3.2. DDD 领域驱动</a>  
&emsp;<a href="#20">6. 相关资料</a>  
...
### <a name="16">分布式</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

### <a name="17">微服务</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="18">拆分原则</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
垂直划分优先原则：应该根据业务领域对服务进行垂直划分，让团队能关注业务实现。

持续演进原则： 服务数量在非必要的情况下，应该逐步划分，持续演进，避免服务数量的爆炸性增长


#### <a name="19">DDD 领域驱动</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
详细见
