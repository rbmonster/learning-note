...
&emsp;&emsp;<a href="#62">5.7. 文件/网络IO</a>  
...
### <a name="25">Swap机制</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="41">信号量</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="46">生产者-消费者问题</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="58">文件使用</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="59">文件存储</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="60">文件系统结构</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="61">软链接和硬链接</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="62">文件/网络IO</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
- 缓冲与非缓冲 I/O
- 直接与非直接 I/O
- 阻塞与非阻塞 I/O VS 同步与异步 I/O


#### <a name="63">缓冲与非缓冲 I/O</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="64">直接与非直接 I/O</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="65">阻塞与非阻塞 I/O VS 同步与异步 I/O</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
I/O 是分为两个过程的：
1. 数据准备的过程
...
#### <a name="66">IO多路复用</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
##### <a name="67">select/poll</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
##### <a name="68">epoll</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="69">Reactor</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="70">Proactor</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="71">page cache</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="72">page与page cache</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="73">Page Cache 与 buffer cache</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="74">Page Cache 与预读</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="75">持久化的一致性&可靠性</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="76">page cache 优劣势</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
Page Cache 的优势
...
#### <a name="77">参考资料</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
[Linux 的 Page Cache](https://spongecaptain.cool/SimpleClearFileIO/1.%20page%20cache.html)



### <a name="78">直接内存访问</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="79">零拷贝</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="80">mmap + write</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
```
buf = mmap(file, len);
...
#### <a name="81">sendfile</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="82">计算机组成原理</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

## <a name="83">局部性原理</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
// TODO
[计算机组成原理：局部性原理](https://blog.csdn.net/zhizhengguan/article/details/121172704)


# <a name="84">中间件设计资料</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
