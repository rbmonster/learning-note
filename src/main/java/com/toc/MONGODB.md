...
![avatar](https://gitee.com/rbmon/file-storage/blob/main/learning-note/other/mongodb/mongodbCompare.png)
...
![avatar](https://gitee.com/rbmon/file-storage/blob/main/learning-note/other/mongodb/mongodbvs.png)


![avatar](https://gitee.com/rbmon/file-storage/blob/main/learning-note/other/mongodb/mongodbSummary.png)
![avatar](https://gitee.com/rbmon/file-storage/blob/main/learning-note/other/mongodb/mongodbFunction.png)


### <a name="10">应用场景</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
![avatar](https://gitee.com/rbmon/file-storage/blob/main/learning-note/other/mongodb/mongodbApplication.png)
除了上述场景，还有:
...
![avatar](https://gitee.com/rbmon/file-storage/blob/main/learning-note/other/mongodb/mongodbPresure.png)


### <a name="12">常见架构</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
![avatar](https://gitee.com/rbmon/file-storage/blob/main/learning-note/other/mongodb/mongodbdesign.png)
