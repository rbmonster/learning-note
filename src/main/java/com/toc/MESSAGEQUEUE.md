...
&emsp;&emsp;&emsp;&emsp;<a href="#3">解耦</a>  
&emsp;&emsp;&emsp;&emsp;<a href="#4">削峰</a>  
&emsp;<a href="#5">系统复杂度</a>  
&emsp;&emsp;<a href="#6">重复消费</a>  
&emsp;&emsp;&emsp;<a href="#7">接口幂等性</a>  
&emsp;&emsp;<a href="#8">顺序消费</a>  
&emsp;&emsp;<a href="#9">保证消息不丢失</a>  
&emsp;&emsp;<a href="#10">消息堆积</a>  
&emsp;&emsp;<a href="#11">数据一致性</a>  
&emsp;&emsp;<a href="#12">可用性</a>  
&emsp;<a href="#13">消息队列选型</a>  
&emsp;&emsp;<a href="#14">消息队列模型</a>  
&emsp;&emsp;&emsp;<a href="#15">队列模型</a>  
&emsp;&emsp;&emsp;<a href="#16">发布订阅模型</a>  
<a href="#17">Kafka</a>  
&emsp;<a href="#18">基本概念</a>  
&emsp;&emsp;&emsp;<a href="#19">分布式的kafka解决节点宕机或者抖动问题</a>  
&emsp;&emsp;&emsp;<a href="#20">消息消费细节</a>  
&emsp;<a href="#21">与ZooKeeper的依赖</a>  
&emsp;&emsp;<a href="#22">Broker 注册 </a>  
&emsp;&emsp;<a href="#23">Topic 注册 </a>  
&emsp;&emsp;<a href="#24">负载均衡 </a>  
&emsp;&emsp;<a href="#25">消息 消费进度Offset 记录</a>  
&emsp;<a href="#26">面试题</a>  
&emsp;&emsp;&emsp;<a href="#27">kafka优点</a>  
&emsp;&emsp;<a href="#28">kafka 为什么快</a>  
&emsp;&emsp;&emsp;<a href="#29">顺序写磁盘</a>  
&emsp;&emsp;&emsp;<a href="#30">大量使用内存页</a>  
&emsp;&emsp;&emsp;<a href="#31">零拷贝技术</a>  
&emsp;&emsp;&emsp;<a href="#32">消息压缩、批量发送</a>  
&emsp;&emsp;<a href="#33">Kafka 如何保证消息队列不丢失</a>  
&emsp;&emsp;<a href="#34">数据写到消息队列，可能会存在数据丢失问题，数据在消息队列需要持久化(磁盘？数据库？Redis？分布式文件系统？)</a>  
&emsp;&emsp;<a href="#35">想要保证消息（数据）是有序的，怎么做？</a>  
&emsp;&emsp;<a href="#36">为什么在消息队列中重复消费了数据</a>  
<a href="#37">RocketMQ</a>  
&emsp;<a href="#38">基本概念</a>  
&emsp;<a href="#39">基本架构</a>  
&emsp;<a href="#40">优缺点</a>  
&emsp;<a href="#41">事务实现</a>  
