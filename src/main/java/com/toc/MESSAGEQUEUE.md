...
&emsp;&emsp;&emsp;&emsp;<a href="#2">1.0.1.4. 异步</a>  
&emsp;&emsp;&emsp;&emsp;<a href="#3">1.0.1.5. 解耦</a>  
&emsp;&emsp;&emsp;&emsp;<a href="#4">1.0.1.6. 削峰</a>  
...
&emsp;&emsp;<a href="#11">2.5. 数据一致性</a>  
&emsp;&emsp;<a href="#12">2.6. 可用性</a>  
&emsp;<a href="#13">3. 消息队列选型</a>  
&emsp;&emsp;<a href="#14">3.1. 消息队列模型</a>  
&emsp;&emsp;&emsp;<a href="#15">3.1.1. 队列模型</a>  
&emsp;&emsp;&emsp;<a href="#16">3.1.2. 发布订阅模型</a>  
<a href="#17">Kafka</a>  
&emsp;<a href="#18">1. 基本概念</a>  
&emsp;&emsp;&emsp;<a href="#19">1.0.3. 分布式的kafka解决节点宕机或者抖动问题</a>  
&emsp;&emsp;&emsp;<a href="#20">1.0.4. 消息消费细节</a>  
&emsp;<a href="#21">2. 与ZooKeeper的依赖</a>  
&emsp;&emsp;<a href="#22">2.1. Broker 注册 </a>  
&emsp;&emsp;<a href="#23">2.2. Topic 注册 </a>  
&emsp;&emsp;<a href="#24">2.3. 负载均衡 </a>  
&emsp;&emsp;<a href="#25">2.4. 消息 消费进度Offset 记录</a>  
&emsp;<a href="#26">3. 面试题</a>  
&emsp;&emsp;&emsp;<a href="#27">3.0.1. kafka优点</a>  
&emsp;&emsp;<a href="#28">3.1. kafka 为什么快</a>  
&emsp;&emsp;&emsp;<a href="#29">3.1.1. 顺序写磁盘</a>  
&emsp;&emsp;&emsp;<a href="#30">3.1.2. 大量使用内存页</a>  
&emsp;&emsp;&emsp;<a href="#31">3.1.3. 零拷贝技术</a>  
&emsp;&emsp;&emsp;<a href="#32">3.1.4. 消息压缩、批量发送</a>  
&emsp;&emsp;<a href="#33">3.2. Kafka 如何保证消息队列不丢失</a>  
&emsp;&emsp;<a href="#34">3.3. 数据写到消息队列，可能会存在数据丢失问题，数据在消息队列需要持久化(磁盘？数据库？Redis？分布式文件系统？)</a>  
&emsp;&emsp;<a href="#35">3.4. 想要保证消息（数据）是有序的，怎么做？</a>  
&emsp;&emsp;<a href="#36">3.5. 为什么在消息队列中重复消费了数据</a>  
<a href="#37">RocketMQ</a>  
&emsp;<a href="#38">1. 基本概念</a>  
&emsp;<a href="#39">2. 基本架构</a>  
&emsp;<a href="#40">3. 优缺点</a>  
&emsp;<a href="#41">4. 事务实现</a>  
...
### <a name="11">数据一致性</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
- 使用分布式事务解决消息发送后，一个消息被不同系统分别监听可能导致的 数据不一致问题。
  - 如把下单，优惠券，积分。。。都放在一个事务里面一样，要成功一起成功，要失败一起失败。
  
### <a name="12">可用性</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
- 如何保证消息队列可用


## <a name="13">消息队列选型</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
目前主要的消息队列有 ActiveMQ、RabbitMq、Kafka、RocketMq，用的比较多的是Kafka和RocketMq两个，主要这两个都支持10万级的高吞吐量，而且相应的开发社区活跃，遇到源码问题便于维护。

### <a name="14">消息队列模型</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
消息队列有两种模型：队列模型和发布/订阅模型。

#### <a name="15">队列模型</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="16">发布订阅模型</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="17">Kafka</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="19">分布式的kafka解决节点宕机或者抖动问题</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="20">消息消费细节</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
## <a name="21">与ZooKeeper的依赖</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="22">Broker 注册 </a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="23">Topic 注册 </a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="24">负载均衡 </a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="25">消息 消费进度Offset 记录</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
## <a name="26">面试题</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="27">kafka优点</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="28">kafka 为什么快</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

- 顺序写磁盘、大量使用内存页 、零拷贝技术的使用、消息压缩及批量发送

#### <a name="29">顺序写磁盘</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="30">大量使用内存页</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
mmf （Memory Mapped Files）直接利用操作系统的Page来实现文件到物理内存的映射，完成之后对物理内存的操作会直接同步到硬盘。mmf 通过内存映射的方式大大提高了IO速率，省去了用户空间到内核空间的复制。

#### <a name="31">零拷贝技术</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="32">消息压缩、批量发送</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="33">Kafka 如何保证消息队列不丢失</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="34">数据写到消息队列，可能会存在数据丢失问题，数据在消息队列需要持久化(磁盘？数据库？Redis？分布式文件系统？)</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
- Kafka会将partition以消息日志的方式(落磁盘)存储起来，通过 顺序访问IO和缓存(等到一定的量或时间)才真正把数据写到磁盘上，来提高速度。

### <a name="35">想要保证消息（数据）是有序的，怎么做？</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
- Kafka会将数据写到partition，单个partition的写入是有顺序的。如果要保证全局有序，那只能写入一个partition中。如果要消费也有序，消费者也只能有一个。

### <a name="36">为什么在消息队列中重复消费了数据</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="37">RocketMQ</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

## <a name="38">基本概念</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
## <a name="39">基本架构</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
## <a name="40">优缺点</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
- 单机吞吐量：十万级
- 可用性：非常高，分布式架构
...
## <a name="41">事务实现</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
