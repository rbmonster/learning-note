...
### 一条update语句的执行流程
![image](https://raw.githubusercontent.com/rbmonster/file-storage/main/learning-note//other/mysql/updateProcess.jpg)
...
### 区分隔离级别（例子）
![image](https://raw.githubusercontent.com/rbmonster/file-storage/main/learning-note//other/mysql/transactionProcess.jpg)
...
![image](https://raw.githubusercontent.com/rbmonster/file-storage/main/learning-note//other/mysql/transactiongeli.jpg)
...
- 行状态说明
![image](https://raw.githubusercontent.com/rbmonster/file-storage/main/learning-note//other/mysql/lineState.jpg)
...
4. 把事务A的查询语句select * from t where id=1修改一下， 加上lock in share mode 或for update， 也都可以读到版本号是101的数据， 返回的k的值是3。
  - ```
    ...
    ```
- 所等待的例子，更新结果也为3。
![image](https://raw.githubusercontent.com/rbmonster/file-storage/main/learning-note//other/mysql/transactiongeli3.jpg)
...
![image](https://raw.githubusercontent.com/rbmonster/file-storage/main/learning-note//other/mysql/errorIndex1.jpg)
![image](https://raw.githubusercontent.com/rbmonster/file-storage/main/learning-note//other/mysql/errorIndex2.jpg)
```
// 设置慢查询日志
...
![image](https://raw.githubusercontent.com/rbmonster/file-storage/main/learning-note//other/mysql/phantomRead3.jpg)
...
- 死锁案例（间隙锁不互斥导致）
![image](https://raw.githubusercontent.com/rbmonster/file-storage/main/learning-note//other/mysql/phantomRead4.jpg)
...
- 锁范围增长
![image](https://raw.githubusercontent.com/rbmonster/file-storage/main/learning-note//other/mysql/nextKeyLockExtend.jpg)
...
![image](https://raw.githubusercontent.com/rbmonster/file-storage/main/learning-note//other/mysql/redologFlush.jpg)
...
![image](https://raw.githubusercontent.com/rbmonster/file-storage/main/learning-note//other/mysql/memoryflash.jpg)
...
#### 重建表消除数据空洞
![image](https://raw.githubusercontent.com/rbmonster/file-storage/main/learning-note//other/mysql/rebuildTable.jpg)
```
...
##### 等flush
  - ```
    ...
    ```
  - 两个flush table的语句
![image](https://raw.githubusercontent.com/rbmonster/file-storage/main/learning-note//other/mysql/longquery.jpg)
...
#### 查询慢
![image](https://raw.githubusercontent.com/rbmonster/file-storage/main/learning-note//other/mysql/slowquery1.jpg)

![image](https://raw.githubusercontent.com/rbmonster/file-storage/main/learning-note//other/mysql/slowquery2.jpg)
```
//session A
...
### 主从同步流程图
![image](https://raw.githubusercontent.com/rbmonster/file-storage/main/learning-note//other/mysql/masterSlave.jpg)
一个事务日志同步的完整过程是这样的：
...
### Innodb的内存管理策略LRU
![image](https://raw.githubusercontent.com/rbmonster/file-storage/main/learning-note//other/mysql/LRU1.jpg)
...
![image](https://raw.githubusercontent.com/rbmonster/file-storage/main/learning-note//other/mysql/LRU2.jpg)
