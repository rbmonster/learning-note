package com.learning.concurrent.performance.collection;//: concurrency/MapComparisons.java
// {Args: 1 10 10} (Fast verification check during build)
// Rough comparison of thread-safe Map performance.


import com.learning.concurrent.performance.collection.other.CountingGenerator;
import com.learning.concurrent.performance.collection.other.MapData;
...
/**
 * 对比Collections.synchronizedMap 与ConcurrentHashMap的性能表现
 */
