package com.learning.concurrent.performance.collection;//: concurrency/ListComparisons.java
// {Args: 1 10 10} (Fast verification check during build)
// Rough comparison of thread-safe List performance.

import com.learning.concurrent.performance.collection.other.CountingIntegerList;
...
/**
 * 对比Collections.synchronizedList 与 CopyOnWriteArrayList 的性能
 */
